"""
Django settings for twittera project.
...
SECRET_KEY = 'd9kz0_b(1^$p4)$*o3hwt0pmz1y8#q)!z!z^%s5z+lc!6&u1!n'
...
WSGI_APPLICATION = 'twittera.wsgi.application'
